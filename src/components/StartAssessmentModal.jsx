...
const StartAssessmentModal = () => {
  return (
    <div className="fixed top-0 left-0 h-screen w-full bg-[#00000061] flex items-center justify-center">
      <div className="rounded-t-2xl overflow-hidden w-[300px] md:w-[500px] lg:w-[600px]">
        <div className="flex justify-between items-center px-4 md:px-10 py-4 bg-[#755ae2]">
          ...
          <button className="px-3 md:px-7 py-2 bg-[#f5f3ff33] text-white rounded-xl">close</button>
        </div>
        ...
        <div className="py-5 px-10 bg-white flex justify-center md:justify-end rounded-b-2xl">
          <button className="py-3 px-7 bg-[#755ae2] text-white rounded-xl">Proceed</button>
        </div>
      </div>
    </div>
  );
