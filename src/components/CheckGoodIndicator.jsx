const CheckGoodIndicator = ({ icon: Icon, title, topIcon: TopIcon }) => {
  return (
    <div className="relative bg-[#f5f3ff] flex flex-col gap-1.5 justify-center items-center py-3 w-28 rounded-xl">
      <div className="rounded-full p-[1px] bg-[#e6e0ff] ring-2 ring-[#755ae2]">
...
export default CheckGoodIndicator;
