      ...
      <main className="pt-7 pb-20 px-7 md:px-[12%]">
        <div className="bg-white w-full rounded-2xl p-10">
          ...
          <div className="mt-5 flex flex-col md:flex-row gap-4">
            <div className="bg-gray-100 w-60 md:w-96 aspect-[16/9] border border-[#755ae2] rounded-xl"></div>
          ...
          <button className="p-3 bg-[#755ae2] text-white rounded-xl mt-7">Take picture and continue</button>
        </div>
      </main>
